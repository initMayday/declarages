...
function Run.execute(Configuration)
    ...
    for _, Value in ipairs(InstalledPackages) do --> Sometimes the "Application ID" header pops up
    ...
    local PackagesToInstall = Common.subtract_arrays(Configuration.Flatpak.Primary, InstalledPackages);
